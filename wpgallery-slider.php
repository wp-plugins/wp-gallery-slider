...
Description: This plugin automatically add the Highslide onclick="return hs.expand(this);" to linked images  in a post, focusing on the wp-gallery shorcode. The required Highslide for WP files are Already Added so dont worry. Just Activate the plugin. Create you WP-Gallery and Go to the front end and click your Thums to it working.
Author: ShapCyber
